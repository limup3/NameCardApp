...
export default function BcTyping() {
    ...
    const handleComplete = (e) => {
        if (bcData.bcinformation.bcName !== "") {
            ...
            axios
                .post(`http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardocr/`, ocrJson, headers)
                .then((response) => {
                    axios
                        .post(
                            "http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscard/",
                            {
