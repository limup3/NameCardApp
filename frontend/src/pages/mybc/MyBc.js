...
export default function MyBc() {
    ...
    useEffect(() => {
        ...
        axios
            .get("http://businesscard.koreacentral.cloudapp.azure.com:8000/api/rest-auth/user/", headers)
            .then((response) => {
                // 유저 키값 호출
                axios
                    .get(
                        `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscard/?user_id=${response.data.pk}&my_bc=1`,
                        headers
                    )
                    .then((response) => {
                        // 내명함인지 판단
                ...
                axios
                    .get(
                        `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscard/?user_id=${response.data.pk}&ocr_id_type=Success${userSorting}`,
                        headers
                    )
                    .then((response) => {
                ...
                axios
                    .get(
                        `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardocr/?user_id=${response.data.pk}&type=Success`,
                        headers
                    )
                    .then((response) => {
                        // 로그인한 유저 ocr데이터 호출
                ...
                axios
                    .get(
                        `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardocr/?user_id=${response.data.pk}&type=Unrecognizable`,
                        headers
                    )
                    .then((UnrecognizableResponse) => {
                        axios
                            .get(
                                `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardocr/?user_id=${response.data.pk}&type=Recognizing`,
                                headers
                            )
            ...
            if (base64) {
                ...
                axios
                    ...
                    .then((response) => {
                        ...
                        axios
                            .post(
                                "http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardocr/",
                                {
                                    type: "Unrecognizable",
                            ...
                            .then((ocrResponse) => {
                                ...
                                axios
                                    .get(
                                        `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardocr/${ocrResponse.data.id}/`,
                                        headers
                                    )
                                    .then((getOcrResponse) => {
                        ...
                        <Card className={classes.root}>
                            ...
                            {mybc !== true && (
                                <CardContent>
                                    ...
                                    />
                                    <label htmlFor="image-file" onClick={handleMyBcCheck}>
                                        <Paper className={classes.paper}>
                                            <Grid container>
