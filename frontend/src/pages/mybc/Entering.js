...
export default function Entering() {
    ...
    const handleDelete = () => {
        checked.forEach(function (data, idx) {
            ...
            axios
                .delete(`http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardocr/${data.id}/`, headers)
                .then((response) => {
            ...
            {!edit && (
                <>
                    ...
                    <br />
                    {
                        ...
                        bcList.map((data, i) => (
                            <Link to={`/EnteringEdit/${data.id}`} style={{ textDecoration: "none" }} key={i}>
