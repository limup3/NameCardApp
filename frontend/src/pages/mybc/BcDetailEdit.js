...
export default function BcDetailEdit() {
    ...
    const handleComplete = () => {
        ...
        axios
            .put(`http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscard/${location.state.id}/`, bcJson, headers)
            .then((response) => {
                history.goBack();
            })
            .catch((error) => {
    ...
    const handleDelete = () => {
        ...
        axios
            .delete(`http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscard/${location.state.id}/`, headers)
            .then((response) => {
                history.push("/Mybc");
            })
            .catch((error) => {
