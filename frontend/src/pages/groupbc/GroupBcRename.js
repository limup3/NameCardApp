...
export default function GroupBcRename({ match }) {
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardbook/${match.params.id}/`, headers)
            .then((response) => {
    ...
    const handleComplete = () => {
        ...
        axios
            .patch(
                `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardbook/${match.params.id}/`,
                {
                    name: bookName,
                },
                headers
