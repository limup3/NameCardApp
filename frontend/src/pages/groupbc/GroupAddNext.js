...
export default function GroupAddNext() {
    ...
    const handleBack = (e) => {
        ...
        if (location.state !== undefined) {
            ...
            axios
                .delete(
                    `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/groupbusinesscard/${location.state.groupPk}/`,
    ...
    const handleCreate = (e) => {
        ...
        axios
            .post(
                `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardbook/`,
