...
export default function Groupbc() {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                axios
                    .get(
                        `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/groupbusinesscard/?user_id=${response.data.pk}`,
                        headers
                    )
                    .then((response) => {
                ...
                axios
                    .get(
                        `http://businesscard.koreacentral.cloudapp.azure.com:8000/api/businesscardbook/?user_id=${response.data.pk}`,
                        headers
                    )
                    .then((response) => {
    ...
    const handleGroupDelete = (event) => {
        ...
        axios
            .delete(`http://businesscard.koreacentral.cloudapp.azure.com:8000/api/groupbusinesscard/${myValue}/`, headers)
            .then((response) => {
