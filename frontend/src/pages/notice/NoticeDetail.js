...
export default function NoticeDetail({ match }) {
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://businesscard.koreacentral.cloudapp.azure.com:8000/api/notice/${match.params.id}/`, headers)
            .then((response) => {
        ...
        <>
            <Grid container>
                ...
                <Grid item xs={12} style={{ lineHeight: "1.5" }}>
                    ...
                    {noticeData.image !== null && <img style={{ margin: "1rem" }} src={noticeData.image} alt={"공지사항 이미지"} />}
                </Grid>
            </Grid>
        </>
    );
